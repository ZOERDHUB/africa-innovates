...
const WEEKS = [
  {
    ...
    days: [
      ...
      "Sept. 7: Weekly Build Challenge + Community Voting — ZOERDHUB, 1:00 PM WAT",
      "Sept. 8: Rest / Community Engagement Day — ZOERDHUB, 1:00 PM WAT",
    ],
  },
  {
    label: "WEEK 2",
...
const FALLBACK_TIMETABLE = [
  ...
  ["Sept. 7", "1:00 PM WAT", "Weekly Build Challenge + Community Voting", "ZOERDHUB", "Week 1 — Foundations"],
  ["Sept. 8", "1:00 PM WAT", "Rest / Community Engagement Day", "ZOERDHUB", "Week 1 — Foundations"],
  ...
  ["Sept. 14", "1:00 PM WAT", "Security + Security Review Challenge", "ZOERDHUB", "Week 2 — Building"],
  ["Sept. 15", "1:00 PM WAT", "Testing + Testing Challenge", "ZOERDHUB", "Week 2 — Building"],
  ["Sept. 16", "1:00 PM WAT", "Production Development + Deployment Challenge", "ZOERDHUB", "Week 3 — Ship, Open Source & Demo"],
