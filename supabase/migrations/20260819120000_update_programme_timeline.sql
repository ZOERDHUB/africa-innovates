...
insert into public.schedule_items (day_label, time_label, session_title, facilitator, description, sort_order) values
  ...
  ('Sept. 14', '', 'Security + Security Review Challenge', 'ZOERDHUB', 'Week 2 — Building', 13),
  ('Sept. 15', '', 'Testing + Testing Challenge', 'ZOERDHUB', 'Week 2 — Building', 14),
  ('Sept. 16', '', 'Production Development + Deployment Challenge', 'ZOERDHUB', 'Week 3 — Ship, Open Source & Demo', 15),
  ...
  ('Sept. 19', '', 'Demo Day Preparation + Final Project Review', 'ZOERDHUB', 'Week 3 — Ship, Open Source & Demo', 18),
